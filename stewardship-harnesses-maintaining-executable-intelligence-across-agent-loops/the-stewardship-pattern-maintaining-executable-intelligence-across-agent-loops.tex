...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.05\linewidth}
                ...
                >{\raggedright\arraybackslash}p{0.33\linewidth}@{}}
\toprule
\textbf{Step} & \textbf{Event} & \textbf{Maintained state} & \textbf{Stewardship effect} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Illustrative state-transition trace for the company-intelligence scenario. The table specifies maintained-state semantics, not experimental results.}
